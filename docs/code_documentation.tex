...
\title{GPS Decoder\\Code Documentation}
\author{Educational GPS Decoder Repository}
...
This document describes all source code in the repository root. It covers the Python application under \codepath{app/}, the pytest suite under \codepath{app/tests/}, and the PowerShell repository tools under \codepath{tools/}. Large local IQ captures such as \codepath{*.bin} files are intentionally excluded because they are analysis assets, not source code.
