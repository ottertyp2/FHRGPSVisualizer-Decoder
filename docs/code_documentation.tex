...
\newcommand{\apiitem}[2]{\item \texttt{#1}: #2}
\newcommand{\apisym}[1]{\item \texttt{#1}}
...
\begin{longtable}{>{\ttfamily}p{0.33\linewidth}p{0.60\linewidth}}
...
\subsection{\codepath{app/dsp/acquisition.py}}
...
\subsection{\codepath{app/dsp/benchmark.py}}
...
\subsection{\codepath{app/dsp/bitsync.py}}
...
\subsection{\codepath{app/dsp/compute.py}}
...
\subsection{\codepath{app/dsp/concept_lab.py}}
...
\subsection{\codepath{app/dsp/demo.py}}
...
\subsection{\codepath{app/dsp/ephemeris.py}}
...
\subsection{\codepath{app/dsp/gps_ca.py}}
...
\subsection{\codepath{app/dsp/io.py}}
...
\subsection{\codepath{app/dsp/navdecode.py}}
...
\subsection{\codepath{app/dsp/pvt.py}}
...
\subsection{\codepath{app/dsp/pvt_pipeline.py}}
...
\subsection{\codepath{app/dsp/tracking.py}}
...
\subsection{\codepath{app/dsp/tracking_gpu.py}}
...
\subsection{\codepath{app/dsp/utils.py}}
...
\subsection{\codepath{app/models/session.py}}
...
\subsection{\codepath{app/gui/main_window.py}}
...
\subsection{\codepath{app/gui/tabs/acquisition_tab.py}}
...
\subsection{\codepath{app/gui/tabs/navigation_tab.py}}
...
\subsection{\codepath{app/gui/tabs/pvt_tab.py}}
...
\subsection{\codepath{tools/check_git_sync.ps1}}
